...
export default function ChatBox({ queuedMessage = null, onLoadingChange }: ChatBoxProps) {
  ...
  return (
    <section className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-[#d8d0b9] bg-[#f8f2df] shadow-sm">
      <div className="flex-1 min-h-0 overflow-y-auto px-4 py-5 md:px-6">
        <div className="flex min-h-full flex-col">
          {isInitialView ? (
            <div className="mx-auto mb-4 max-w-2xl rounded-2xl border border-[#e4dbc3] bg-[#f5edd7]/80 px-5 py-5 text-center">
              <p className="inline-flex items-center rounded-full border border-[#d5c9ab] bg-[#f9f3df] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[#3f5f44]">
                Orientación agrícola local
              </p>
              <h2 className="mt-3 text-xl font-semibold text-[#24402d] md:text-2xl">
                Bienvenido a AgroManabí IA
              </h2>
              <p className="mt-2 text-sm leading-relaxed text-[#536a54]">
          ...
          <div className={`space-y-4 pb-2 ${isInitialView ? "" : "mt-auto"}`}>
            ...
            {isLoading ? (
              <div className="flex items-end gap-2">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#c8bea4] bg-[#f0e7cb] text-xs font-bold text-[#2d5137]">
                  AI
                </div>
      ...
      <div className="border-t border-[#e1d6bb] bg-[#f8f2df] p-4">
        <div className="rounded-xl border border-[#d8cdb0] bg-[#fbf6e7] p-2">
          <div className="flex items-center gap-2">
            <input
              className="flex-1 rounded-xl border border-transparent bg-transparent px-3 py-2 text-sm text-[#24402d] placeholder:text-[#7d8e77] focus:outline-none focus:ring-2 focus:ring-[#3d7c48] disabled:cursor-not-allowed disabled:opacity-60"
              value={input}
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#2f6b3f] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#255c34] focus:outline-none focus:ring-2 focus:ring-[#2f6b3f] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={isLoading}
            >
              <svg
                viewBox="0 0 24 24"
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-2 px-1 text-xs text-[#788971]">
